...
<head>
<meta charset="UTF-8">
<link href="/ogeul/css/sorting2.css" rel="stylesheet" type="text/css">
<link href="/ogeul/css/jquery.fancybox.min.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/ogeul/js/jquery-3.1.1.min.js"></script>
<!-- <script src="js/jquery.fancybox-1.3.4.pack.js"></script> -->
<script src="/ogeul/js/jquery.fancybox.js"></script>
<!-- <script type="text/javascript" src="js/script.js"></script> -->
<script type="text/javascript" src="/ogeul/js/sorting2.js"></script>
			...
			<tr>
				<td>
					<table id="innerTable">
						<tr>
							<td id="td">
								<img src="/ogeul/images/music-headphones-icon-coloring-book-colouring-scallywag-coloring-5aNjee-clipart[1].png">
							</td>
						</tr>
						<tr>
							<td><p><a data-fancybox data-src="/ogeul/views/board/BoardDetail.jsp?boardNum=3&category=4">어리다고 놀리지 말아요</a></p></td>
						</tr>
					</table>
				</td>
				<td>
				...
				<td>
					<table id="innerTable">
						<tr>
							<td id="td">
								<img src="/ogeul/images/f01714817750f2b3d22c5ab81dc53ddf[1].png">
							</td>
						</tr>
						<tr>
							<td>
								...
								<img src="/ogeul/images/2408384A5240FD0C39F5E9[1].jpg"></a>
							</td>
						</tr>
					</table>
				</td>
				<td>
					<table id="innerTable">
						<tr>
							<td id="td">
								<img src="/ogeul/images/5020-200[1].png">
							</td>
						</tr>
						<tr>
...
<img src="/ogeul/images/top[1].png" width="100" height="60"></a>
